...
- **주제 : 생성 AI 모델을 활용한 개인맞춤 경제 뉴스 기사 추천 서비스**
  - 금융 어플리케이션의 MAU (Monthly Active User) 및 DAU (Daily Active User)를 증가시키기 위한 컨텐츠 추가 및 하루 한번 접속을 위한 일상 그 자체를 녹여낼 수 있는 컨텐츠 필요
...
- 높은 리텐션은 기업의 지속적인 성장을 위한 핵심 요소로 장기적인 관점에서도 고객 가치를 극대화
